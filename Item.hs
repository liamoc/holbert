...
syntaxDecl :: Prism' Item SD.SyntaxDecl
...
instance Control Item where
  ...
  handle (SyntaxDeclAct a) (SyntaxDecl s) = fmap SyntaxDecl . zoomFocus SyntaxDeclFocus $ handle a s
